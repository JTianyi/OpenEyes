 ...
 * @author wangweijian
 */
public class AccordTimeAdapter extends BaseAdapter {
    private AccordBean accordBean;
    private Context context;

    public AccordTimeAdapter(Context context) {
        this.context = context;
    }

    public void setAccordTimeBean(AccordBean accordTimeBean) {
        this.accordBean = accordTimeBean;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AccordBean.ItemListBean.DataBean dataBean = accordBean.getItemList().get(position).getData();
